...
const translations = {
  ...
  fr: {
    title: "Projets Awqaf",
    subtitle: "Investissez dans les bonnes œuvres continues et contribuez à construire un meilleur avenir pour les générations futures",
    loading: "Chargement des projets...",
    errorTitle: "Une erreur est survenue",
    errorRetry: "Réessayer",
    emptyTitle: "Aucun projet disponible",
    emptyDesc: "Désolé, nous n'avons trouvé aucun projet de waqf pour le moment",
    refreshButton: "Actualiser la page",
  },
  en: {
    title: "Awqaf Projects",
    subtitle: "Invest in ongoing charity and help build a better future for the next generations",
    loading: "Loading projects...",
    errorTitle: "An error occurred",
    errorRetry: "Retry",
    emptyTitle: "No projects available",
    emptyDesc: "Sorry, we couldn't find any waqf projects at the moment",
...
export default function Awkaf() {
  const api = useApi();
  const { language } = useLanguage(); // <-- langue courante
  const t = translations[language]; // <-- raccourci

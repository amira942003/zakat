...
export const CalForm = () => {
  ...
  useEffect(() => {
    const handleClickOutside = (e) => {
      if (!e.target.closest("#dl-wrapper")) setDropdownOpen(false);
    };
      ...
      <div className="bg-gradient-to-r from-emerald-900 via-emerald-800 to-teal-700 text-white py-16 mt-15 max-sm:py-8 mb-2">
        <div className="container text-center mx-auto px-6">
          ...
          <div className="mt-8 flex justify-center">
            <div className="relative" id="dl-wrapper">
              <button
                onClick={() => setDropdownOpen(!dropdownOpen)}
                className="flex items-center gap-2 border-2 border-yellow-400 text-yellow-400 px-6 py-3 rounded-xl font-bold hover:bg-yellow-400 hover:text-emerald-900 transition-all duration-300 text-sm"
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth="2.2" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M4 16v2a2 2 0 002 2h12a2 2 0 002-2v-2M7 10l5 5 5-5M12 15V3"/>
                </svg>
                {language === "ar" ? "تحميل الوثائق" : language === "fr" ? "Télécharger les documents" : "Download Documents"}
              </button>

              {dropdownOpen && (
                <div className="absolute top-full mt-2 left-1/2 -translate-x-1/2 bg-white rounded-xl shadow-2xl border border-gray-100 min-w-[280px] z-50 overflow-hidden">

                  {/* XLSX */}
                  <button
                    onClick={() => downloadFile("xlsx")}
                    className="flex items-center gap-3 w-full px-4 py-4 hover:bg-emerald-50 transition-colors border-b border-gray-100 text-right"
                  >
                    ...
                    <div className="flex flex-col text-right flex-1">
                      <span className="font-bold text-gray-800 text-sm">
                        {language === "ar" ? "حاسبة زكاة الشركات" : language === "fr" ? "Calculateur Zakat entreprises" : "Zakat Calculator"}
                      </span>
                      <span className="text-gray-500 text-xs">
                        {language === "ar" ? "جدول Excel لحساب الزكاة" : language === "fr" ? "Tableau Excel de calcul Zakat" : "Excel spreadsheet for Zakat"}
                      </span>
                    </div>
                  ...
                  <button
                    ...
                    className="flex items-center gap-3 w-full px-4 py-4 hover:bg-blue-50 transition-colors text-right"
                  >
                    ...
                    <div className="flex flex-col text-right flex-1">
                      <span className="font-bold text-gray-800 text-sm">
                        {language === "ar" ? "الكتاب الأبيض للزكاة" : language === "fr" ? "Livre blanc Zakat entreprises" : "Zakat White Paper"}
                      </span>
                      <span className="text-gray-500 text-xs">
                        {language === "ar" ? "دليل شامل لزكاة الشركات" : language === "fr" ? "Guide complet Zakat des entreprises" : "Complete guide for corporate Zakat"}
                      </span>
                    </div>

...
export const LanguageSwitcher = () => {
  ...
  const translations = {
    ar: {
      crops: "حاسبة زكاة المحاصيل",
      livestock: "حاسبة زكاة المواشي",
    },
    fr: {
      crops: "Calculatrice Zakat des Cultures",
      livestock: "Calculatrice Zakat du Bétail",
    },
    en: {
      crops: "Crops Zakat Calculator",
      livestock: "Livestock Zakat Calculator",
    },
  };
